...
void SharpLcd_Deinit(void)
{
	...
	// ...
	// Control Pins
	HAL_GPIO_DeInit(s_SHARPLCD__DISP_PORT, s_SHARPLCD__DISP);
	HAL_GPIO_DeInit(s_SHARPLCD__SCS_PORT, s_SHARPLCD__SCS);
	HAL_GPIO_DeInit(s_SHARPLCD__VCOM_PORT, s_SHARPLCD__EXTCOMIN);
	// SPI Pins
	HAL_GPIO_DeInit(s_SHARPLCD__SPI_PORT, s_SHARPLCD__SCLK|s_SHARPLCD__SI);
