...
extern const uint8_t appleLiGothic_22ptBitmaps[];
extern const FontInfo_t appleLiGothic_22ptFontInfo;
extern const FontCharInfo_t appleLiGothic_22ptDescriptors[];
